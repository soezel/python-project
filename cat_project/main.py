...
class Input():     
    def userInput(self):
        ...
        outputBongo.image = outputBongo.pathImage("cat_project/assets/bongo_cat.jpeg")
        outputBongo.txt = "bongo_cat.txt"

        outputNyan = OutputAscii(" ", " ")
        outputNyan.image = outputNyan.pathImage("cat_project/assets/nyan_cat.jpeg")
        outputNyan.txt = "nyan_cat.txt"

        outputNermal = OutputAscii(" ", " ")
        outputNermal.image = outputNermal.pathImage("cat_project/assets/lord_nermal.jpeg")
